          ...
          >
            ...
            <div className="space-y-8">
              <div className="flex items-center gap-6 group">
                ...
                <div>
                  <p className="text-xs text-gray-500 uppercase tracking-widest font-bold">Office</p>
                  <p className="text-lg font-medium">Sulthan Bathery, Wayanad</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-6 group">
                ...
                <div>
                  ...
                  <p className="text-lg font-medium">+91 95448 19365</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-6 group">
                ...
                <div>
                  ...
                  <p className="text-lg font-medium">sajaluseju@gmail.com</p>
                </div>
              </div>
            </div>

            <div className="flex gap-4 mt-12">
              <div className="w-12 h-12 rounded-lg bg-white/5 flex items-center justify-center hover:bg-primary/20 cursor-pointer transition-colors">
              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <select 
                      name="package"
                      className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 focus:border-primary outline-none transition-colors appearance-none"
                    >
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea 
                      ...
                      className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 focus:border-primary outline-none transition-colors resize-none"
                    />
                  </div>
